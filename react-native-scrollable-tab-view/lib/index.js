...
import FooterInifinite from './FooterInfinite'
...
class ScrollableTabView extends Component {
  ...
  _onScrollEnd(){
    ...
    this.props.endRefresh((loading, hasMore) => {
      this.setState({
        isloading:loading,
        hasmore:hasMore
      })
  ...
  renderFooter(){
    if (!this.props.enableFooterInifinite && this.props.endRefresh && typeof this.props.endRefresh === 'function'){
      return null
    }
    return <FooterInifinite
              isLoading={this.state.isloading}
              hasMore={this.state.hasmore}></FooterInifinite>
  }
...
ScrollableTabView.propTypes = {
  ...
  enableFooterInifinite: PropTypes.bool,
}
