...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-blur/react_native_blur.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-fast-image/react_native_fast_image.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-orientation/react_native_orientation.framework"
